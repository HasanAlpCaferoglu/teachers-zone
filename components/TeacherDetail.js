function TeacherDetail({ teacherData }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <h1 className="text-5xl border-b-4 p-10 m-10 text-center ">{teacherData.nameSurname}</h1>
      <div className="info-container image-container flex flex-col items-center space-y-8 w-full xl:flex-row xl:justify-center">
        <img src={teacherData.image} alt={teacherData.nameSurname} className="scale-300 m-32 xl:mr-10 "/>
        <div className="info-container flex flex-col justify-center items-center space-y-4 w-9/12  xl:w-5/12 xl:items-start xl:ml-32">
